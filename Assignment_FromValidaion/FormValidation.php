...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($_POST["pass"])) {
            ...
            $err_password = "*Password must contain upper, lower, special character and number";
        } else {
            $password = $_POST["pass"];
        }
        ...
        <table>
            ...
            <tr>
                ...
                <td>: <input type="password" placeholder="Confirm Password" value="<?php echo $conpassword; ?>" name="cpass">
                    <span><?php echo $err_conpassword; ?></span>
                </td>
            </tr>
